...
export class EmailDomainNameApi extends BaseAPI {
    ...
    public getTopLevelDomainNames(name: string, options?: AxiosRequestConfig) {
        return EmailDomainNameApiFp(this.configuration).getTopLevelDomainNames(name, options).then((request) => request(this.axios, this.basePath));
    }
}
...
export const GivenNameApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getGivenNames: async (name: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'name' is not null or undefined
...
export const GivenNameApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getGivenNames(name: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<NameResponseDto>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getGivenNames(name, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const GivenNameApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getGivenNames(name: string, options?: any): AxiosPromise<NameResponseDto> {
            return localVarFp.getGivenNames(name, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class GivenNameApi extends BaseAPI {
     ...
     */
    public getGivenNames(name: string, options?: AxiosRequestConfig) {
        return GivenNameApiFp(this.configuration).getGivenNames(name, options).then((request) => request(this.axios, this.basePath));
    }
}
